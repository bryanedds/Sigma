...
namespace Sigma.Union2
{
	...
	public class Union<T1, T2, T3, T4, T5, T6, T7, T8>
	{
		...
		public T6 ToT6 => tag == 5 ? value6 : throw new Exception("Unexpected match failure.");
		public T7 ToT7 => tag == 6 ? value7 : throw new Exception("Unexpected match failure.");
		public T8 ToT8 => tag == 7 ? value8 : throw new Exception("Unexpected match failure.");
		...
		public Option<T6> AsT6 => tag == 5 ? Option.Some(value6) : Option.None<T6>();
		public Option<T7> AsT7 => tag == 6 ? Option.Some(value7) : Option.None<T7>();
		public Option<T8> AsT8 => tag == 7 ? Option.Some(value8) : Option.None<T8>();
	...
	public class Union<T1, T2, T3, T4, T5, T6, T7, T8, T9>
	{
		...
		public T7 ToT7 => tag == 6 ? value7 : throw new Exception("Unexpected match failure.");
		public T8 ToT8 => tag == 7 ? value8 : throw new Exception("Unexpected match failure.");
		public T9 ToT9 => tag == 8 ? value9 : throw new Exception("Unexpected match failure.");
		...
		public Option<T7> AsT7 => tag == 6 ? Option.Some(value7) : Option.None<T7>();
		public Option<T8> AsT8 => tag == 7 ? Option.Some(value8) : Option.None<T8>();
		public Option<T9> AsT9 => tag == 8 ? Option.Some(value9) : Option.None<T9>();
